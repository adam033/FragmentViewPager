...
public class Intro extends AppCompatActivity {
    ...
    private String[] description_array = {
            ...
            "ListFragment,DialogFragment,PreferenceFragmentCompat",
            "Android memperkenalkan fragmen di Android 3.0 (API level 11), Untuk mendukung UI Tablet.",
            "OnCreate(),OnStart(),OnPause(),OnStop"
    };
    private int[] about_images_array = {
            R.drawable.hp, R.drawable.code,
            R.drawable.gem, R.drawable.monitor
    };
